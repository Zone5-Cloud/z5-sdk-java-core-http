...
public class TestMetricsAPI extends BaseTest {
	...
	public void testQuery() throws Exception {
		MappedResult<UserWorkoutResultAggregates> result = api.getBikeMetrics(null, Arrays.asList("sum.training","sum.distance","sum.ascent","wavg.avgSpeed","max.maxSpeed","wavg.avgWatts","max.maxWatts"), Arrays.asList("d584c5cb-e81f-4fbe-bc0d-667e9bcd2c4c")).get().getResult();
