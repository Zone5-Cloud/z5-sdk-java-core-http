...
import com.zone5ventures.core.ride.DateTime;
import com.zone5ventures.core.ride.Region;
import com.zone5ventures.core.ride.ScheduledActivityEffort;
import com.zone5ventures.core.ride.ScheduledActivityMaskOpts;
import com.zone5ventures.core.ride.UserScheduledActivity;
import com.zone5ventures.core.ride.UserScheduledActivitySearch;
import com.zone5ventures.core.ride.UserScheduledActivityType;
...
import com.zone5ventures.http.core.api.RideAPI;
...
public class TestUserScheduledActivities extends BaseTest {
	...
	public void testCreateNewRide() throws Exception {
		...
		search.setOrder(Arrays.asList(new Order("ts", com.zone5ventures.core.enums.Order.asc)));
